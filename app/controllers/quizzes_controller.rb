class QuizzesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @quiz.save
        format.html { redirect_to action: 'edit', id: @quiz.id, notice: 'Quiz was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @quiz.update(quiz_params)
        format.html { redirect_to action: 'edit', id: @quiz.id, notice: 'Quiz was successfully updated.' }
